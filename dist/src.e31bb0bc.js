...
var ColumnsBlock = /*#__PURE__*/function (_Block3) {
  ...
  _createClass(ColumnsBlock, [{
    ...
    value: function toHTML() {
      ...
      var columnItems = this.value.map(function (e) {
        return (0, _utils.col)("<p>".concat(e, "</p>"));
      }).join(" ");
      return (0, _utils.row)(columnItems, (0, _utils.css)(styles));
    }
  }]);
...
var Sidebar = /*#__PURE__*/function () {
  ...
  _createClass(Sidebar, [{
    ...
    value: function addBlock(e) {
      ...
      var styles = target.styles.value;
      var newBlock = {};

      if (type === "text") {
        newBlock = new _bloks.TextBlock(value, {
          styles: styles
        });
      } else if (type === "title") {
        newBlock = new _bloks.TitleBlock(value, {
          styles: styles
        });
...
},{"../utils/utils":"utils/utils.js","./bloks":"classes/bloks.js"}],"classes/app.js":[function(require,module,exports) {
"use strict";
...
var model = [new _bloks.TitleBlock("Site constructor on JavaScript!", {
  tag: "h2",
  styles: {
...
}), new _bloks.ImageBlock(_image.default, {
  styles: {
    padding: "2rem 0",
    display: "flex",
  ...
  alt: "this is image"
}), new _bloks.ColumnsBlock(["App on pure JS without libraries", "Solid principals", "handmade UI"], {
  styles: {
...
}), new _bloks.TextBlock("here we go with some text", {
  styles: {
...
},{"./classes/app.js":"classes/app.js","./js/model.js":"js/model.js","./styles/main.css":"styles/main.css"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
